...
import { createProduct, getProductById, getProductList, handleDeleteProduct, updateProductById } from "services/admin/product.service";
...
export {
    getAdminCreateProductPage, postAdminCreateProduct, postDeleteProduct,
    getViewProduct, postUpdateProduct
};